...
func (c *userServiceClient) GetUserByUsername(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (UnimplementedUserServiceServer) GetUserByUsername(context.Context, *User) (*User, error) {
...
func _UserService_GetUserByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserByUsername(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
